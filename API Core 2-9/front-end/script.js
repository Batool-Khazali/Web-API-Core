...
async function deleteCartItem(id) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch(`https://localhost:7192/api/CartItems/${id}`, {
                method: "DELETE",
            });
...
async function searchUser() {
    ...
    const UserByNameAPI = `https://localhost:7192/api/Users/UserByName/${userToSearch}`;
    
    const getURL = await fetch(UserByNameAPI);
    ...
    else
    {
        formDiv.innerHTML = `
                                <div class="formbold-input-group">
                                    <label for="age" class="formbold-form-label"> ID </label>
                                    <input type="text" value="${data.userId}" name="userId" id="ID"
                                        class="formbold-form-input" disabled/>
                                </div>

                                <div class="formbold-input-group">
                                    <label for="name" class="formbold-form-label"> Name </label>
                                    <input type="text" value="${data.username}" name="username" id="name"
                                        class="formbold-form-input" disabled/>
                                </div>
